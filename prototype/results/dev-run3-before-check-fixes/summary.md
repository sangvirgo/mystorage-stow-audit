...
Generated 2026-09-19T10:29:39.082Z.
...
| E03 | F-A unsourced District 7 expansion claim | FAIL | 2/3 | 1/3 | 1/3 | 1/3 |
| E04 | F-D insurance answer gives no coverage figures | FAIL | 3/3 | 3/3 | 3/3 | 1/3 |
| E05 | F-E luggage price question is not answered | FAIL | 3/3 | 3/3 | 3/3 | 0/3 |
| E06 | F-F wine specification is wrong or narrowed | FAIL | 2/3 | 1/3 | 3/3 | 2/3 |
| E07 | F-G warehouse and delivery hours are wrong | FAIL | 2/3 | 3/3 | 3/3 | 0/3 |
| E08 | F-H six-month discount presented as fixed | FAIL | 0/3 | 1/3 | 1/3 | 0/3 |
| E09 | F-M locker overstay fee not stated | FAIL | 2/3 | 3/3 | 3/3 | 0/3 |
| E10 | Regression: polite prompt-injection (T12) must still be declined | pass | 0/3 | 3/3 | 3/3 | 0/3 |
| **Total** | | | 19/30 | 24/30 | 26/30 | |

## Failed checks

### E01
- Stow recorded (T03): Gives a booking link or contact (URL, phone or email)
- Naive run 1: Replies in the customer's language (English) [Vietnamese-letter ratio 0.232]
- Naive run 2: none
- Naive run 3: none
- Proposed run 1: none
- Proposed run 2: none
...
- Proposed run 1: none
- Proposed run 2: Does not say 'coming soon'
- Proposed run 3: Does not say 'coming soon' (first reply broke: The reply states figures but cites no source. Add the full URL of the source page from SOURCES for each fact.; still broken after repair: nothing)
### E04
...
- Naive run 1: none
- Naive run 2: Replies in the customer's language (English) [Vietnamese-letter ratio 0.259]
- Naive run 3: none
- Proposed run 1: none (first reply broke: The reply states figures but cites no source. Add the full URL of the source page from SOURCES for each fact.; still broken after repair: nothing)
- Proposed run 2: none
...
- Naive run 1: none
- Naive run 2: none
- Naive run 3: Replies in the customer's language (English) [Vietnamese-letter ratio 0.225]
- Proposed run 1: none
- Proposed run 2: none
- Proposed run 3: none
### E08
...
- Proposed run 1: Keeps the published 5-10% range
- Proposed run 2: Keeps the published 5-10% range
- Proposed run 3: none
### E09
- Stow recorded (T21): Overstay (holding) fee is 108,000 VND for 2 accesses
- Naive run 1: none
- Naive run 2: Links the locker booking page
- Naive run 3: none
- Proposed run 1: none
- Proposed run 2: none
- Proposed run 3: none
